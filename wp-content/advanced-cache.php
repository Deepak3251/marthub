...
$nitropack_functions_file = 'C:\xampp\htdocs\marthub\wp-content\plugins\nitropack\functions.php';
$nitropack_abspath = 'C:\xampp\htdocs\marthub/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_ADVANCED_CACHE_VERSION', '1.16.8');
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_a7babe12783c5041710c78130429e66d' );
